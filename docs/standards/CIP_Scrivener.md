...
本ツールの名称は、古語で「代書人」や「公証人」を意味する Scrivener に由来します。正確な発音は「スクリヴナー」に近いものですが、本プロジェクトにおいては親しみを込めて、また独自のアイデンティティとして、あえて **「スクリバー」** と呼称します。

## 1. 言語の核心的意図 (Core Philosophy)

CIP-Scrivener v2.0は、Mermaidを基盤とし、人間とAIが「意図」を共有することで、実コードへの安全な橋渡しを行う。
...
CIP-Scrivener v2.0は、Mermaidの標準構文の中に、独自のメタデータ（アノテーション）をMarkdown形式で埋め込む。
